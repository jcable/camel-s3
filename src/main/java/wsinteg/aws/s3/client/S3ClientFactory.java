 ...
 */
package wsinteg.aws.s3.client;

import wsinteg.aws.s3.S3Configuration;
import wsinteg.aws.s3.client.impl.S3ClientIAMOptimizedImpl;
import wsinteg.aws.s3.client.impl.S3ClientStandardImpl;
